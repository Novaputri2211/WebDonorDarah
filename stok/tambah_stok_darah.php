...
if ($_SERVER["REQUEST_METHOD"] != "POST") {
    ...
    $jlh_kantong_tambah = $_POST['jlh_kantong_darah'];
    ...
    $tambah_stok = $row['jlh_kantong_darah'] + $jlh_kantong_tambah;
    ...
    $set->bindParam(":jlh_kantong_darah", $tambah_stok);
    $set->execute();

    $returnData = msg(1,200,'Input Stok Darah Berhasil');
