...
if ($_SERVER["REQUEST_METHOD"] != "POST") {
...
}else if ( !isset($_POST['id_pendonor']) || !isset($_POST['nama_pendonor']) || !isset($_POST['tempat_lahir']) || !isset($_POST['tgl_lahir']) || !isset($_POST['umur']) || !isset($_POST['jekel']) || !isset($_POST['alamat']) || !isset($_POST['lat']) || !isset($_POST['lng']) || !isset($_POST['no_hp']) || !isset($_POST['gol_darah']) || !isset($_POST['bb']) || !isset($_POST['tensi']) || !isset($_POST['kadar_hb']) || !isset($_POST['tanggal_donor']) || !isset($_POST['jlh_kantong']) ||
         empty(trim($_POST['id_pendonor'])) ||empty(trim($_POST['nama_pendonor'])) || empty(trim($_POST['tempat_lahir'])) || empty(trim($_POST['tgl_lahir'])) || empty(trim($_POST['umur'])) || empty(trim($_POST['jekel'])) || empty(trim($_POST['alamat'])) || empty(trim($_POST['lat'])) || empty(trim($_POST['lng'])) || empty(trim($_POST['no_hp'])) || empty(trim($_POST['gol_darah'])) || empty(trim($_POST['bb'])) || empty(trim($_POST['tensi'])) || empty(trim($_POST['kadar_hb'])) || empty(trim($_POST['tanggal_donor'])) || empty(trim($_POST['jlh_kantong']))
){
    ...
    $set->bindParam(":nama", $nama_pendonor);
